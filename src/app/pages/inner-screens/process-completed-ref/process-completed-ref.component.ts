...
@Component({
  selector: "app-process-completed-ref",
  templateUrl: "./process-completed-ref.component.html",
  styleUrls: ["./process-completed-ref.component.scss"],
})
export class ProcessCompletedRefComponent implements OnInit {
  // Top Categories
  categories = [
    "CAT A (4)",
    "CAT B (2)",
