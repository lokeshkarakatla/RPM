...
export class D2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Fishbone categories for D2
    const fishData = PartsData.fishD2();
    ...
    // Other tabs
    this.values = PartsData.getd2();       // Overview (D2-specific)
    this.documents = PartsData.documentD2(); // Documents (D2-specific)
    this.dataList = PartsData.data();      // CAPA (D2-specific)
  }
