...
export class D3BComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Fishbone categories for D3B
    const fishData = PartsData.fishD3b();
    ...
    // Other tabs
    this.values = PartsData.getd3b();        // Overview (D3B-specific)
    this.documents = PartsData.documentD3b(); // Documents (D3B-specific)
