...
export class D5Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Fishbone categories for D5
    const fishData = PartsData.fishD5();
    ...
    // Other tabs
    this.values = PartsData.getd5();        // Overview (D5-specific)
    this.documents = PartsData.documentD5(); // Documents (D5-specific)
