...
export class D6Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Fishbone categories for D6
    const fishData = PartsData.fishD6();
    ...
    // Other tabs
    this.values = PartsData.getd6();        // Overview (D6-specific)
    this.documents = PartsData.documentD6(); // Documents (D6-specific)
