...
tableData: any[] = [
    ...
    { parameter: 'VISUAL INSPECTION', partName: 'Dashboard Trim', partFamily: 'Interior', spec: '0.00', unit: 'N/A', min: 0, max: 0, defectRate: '8.5%', defects: '17/200', actionLink: '7', special: 'General', method: 'Visual', s1: 0, s2: 0, s3: 0, s4: 1, s5: 0, okay: false },
    { parameter: 'THREAD GAUGE', partName: 'Mounting Bolt', partFamily: 'Fasteners', spec: '10.00', unit: 'M10', min: 0, max: 0, defectRate: '0.5%', defects: '1/200', actionLink: '8', special: 'Critical', method: 'Thread Plug', s1: 0, s2: 0, s3: 0, s4: 0, s5: 0, okay: true },
    ...
    { parameter: 'PACKAGING INTEGRITY', partName: 'Headlight Unit', partFamily: 'Electrical', spec: '1.00', unit: 'N/A', min: 0, max: 0, defectRate: '0.0%', defects: '0/50', actionLink: '10', special: 'General', method: 'Visual', s1: 0, s2: 0, s3: 0, s4: 0, s5: 0, okay: true }
  ];
