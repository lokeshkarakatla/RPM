...
export class ProcessAuditReferenceComponent implements OnInit {
  ...
  },
  {
    id: 10,
    tooltip: 'MM',
    question: 'Are supplier audits or assessments conducted periodically based on risk, performance, or business criticality?'
  },
  {
    id: 11,
    tooltip: 'MM',
    question: 'Are inventory handling, storage conditions, identification, FIFO/FEFO controls, and material preservation practices implemented?'
  },
  {
    id: 12,
    tooltip: 'MM',
    question: 'Are contingency and supply continuity plans established to address material shortages, supplier disruptions, or quality incidents?'
  }
],
   'PPC': [
  {
