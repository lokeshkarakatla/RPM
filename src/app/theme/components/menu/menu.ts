...
export const horizontalMenuItems = [
  ...
  new Menu(3, 'Setup', '/app/testing/stages', null, 'build', null, true, 0),
    new Menu(301, 'Stages', '/app/testing/stages', null, 'layers', null, false, 3),
    new Menu(302, 'Gates', '/app/testing/gates', null, 'door_front', null, false, 3),
    new Menu(306, 'Master Data', '/app/testing/testing-masterData', null, 'storage', null, false, 3),

  // ✅ ADDED: 5. Tasks as Top-Level
  new Menu(5, 'Tasks', '/app/testing/tasks', null, 'task', null, false, 0),

  // ✅ ADDED: 6. Issues as Top-Level
  new Menu(6, 'Issues', '/app/testing/issues', null, 'bug_report', null, false, 0),
  ...
  new Menu(4, 'Admin', '/app/admin', null, 'supervisor_account', null, true, 0),
    ...
    new Menu(404, 'Lookup Options', '/app/admin/lookups', null, 'search', null, false, 4),
    new Menu(405, 'Preferences', '/app/admin/settings', null, 'settings_applications', null, false, 4),
    new Menu(406, 'Event Log', '/app/admin/event-log', null, 'engineering', null, false, 4),
    new Menu(407, 'Escalation Matrix', '/app/admin/escalation', null, 'mail_outline', null, false, 4),
